 ...
 *
 * @returns The core table name (e.g., "shelfline-core-dev")
 ...
 *
 * @returns The base table name (e.g., "shelfline-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "shelfline-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "shelfline-app-realtime-dev")
