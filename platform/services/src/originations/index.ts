/**
 * Originations Services - Application Layer Export
 *
...
/**
 * Originations Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for originations domain.
 */
