/**
 * Telemetry Services - Application Layer Export
 *
...
/**
 * Telemetry Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for telemetry domain.
 */
