/**
 * Breaches Services - Application Layer Export
 *
...
/**
 * Breaches Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for breaches domain.
 */
